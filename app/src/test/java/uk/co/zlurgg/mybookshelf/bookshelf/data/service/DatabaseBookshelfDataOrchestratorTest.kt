...
class DatabaseBookshelfDataOrchestratorTest {
    ...
    @Test
    fun `loadShelfForExport loads shelf with books successfully`() =
        runTest {
            // Given
            val shelf =
                TestShelfBuilder()
    ...
    @Test
    fun `loadShelfForExport returns NOT_FOUND when shelf doesn't exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `loadShelfForExport loads shelf with empty books list`() =
        runTest {
            // Given
            val emptyShelf =
                TestShelfBuilder()
    ...
    @Test
    fun `importShelfToDatabase saves shelf and books successfully`() =
        runTest {
            // Given
            val book1 = TestBookBuilder().withId("book-1").withTitle("Book 1").build()
            val book2 = TestBookBuilder().withId("book-2").withTitle("Book 2").build()
    ...
    @Test
    fun `importShelfToDatabase handles shelf with no books`() =
        runTest {
            // Given
            val emptyShelf =
                TestShelfBuilder()
    ...
    @Test
    fun `importShelfToDatabase handles repository exception`() =
        runTest {
            // Given
            val shelf =
                TestShelfBuilder()
    ...
    @Test
    fun `importShelfToDatabase upserts books correctly`() =
        runTest {
    ...
    @Test
    fun `loadShelfForExport handles multiple shelves correctly`() =
        runTest {
            // Given
