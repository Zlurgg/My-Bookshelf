package uk.co.zlurgg.mybookshelf.bookshelf.data.network
...
class KtorRemoteBookDataSourceTest {
    ...
    @Test
    fun `searchBooks with basic query passes parameters correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `searchBooks with author filter passes filter correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `searchBooks with title filter passes filter correctly`() =
        runTest {
            // Given
            val baseQuery = "kotlin"
    ...
    @Test
    fun `searchBooks with both filters passes both correctly`() =
        runTest {
            // Given
            val baseQuery = "kotlin"
            val authorFilter = "John Doe"
    ...
    @Test
    fun `searchBooks with empty query returns results`() =
        runTest {
            // Given
    ...
    @Test
    fun `searchBooks with language parameter passes language correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `searchBooks handles network error correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `getBookDetails passes book ID correctly`() =
        runTest {
            // Given
            val bookId = "OL123456W"
            mockDataSource.configureBookDetailsResponse(
                uk.co.zlurgg.mybookshelf.bookshelf.data.book.dto.BookWorkDto(description = "Test description"),
            )
