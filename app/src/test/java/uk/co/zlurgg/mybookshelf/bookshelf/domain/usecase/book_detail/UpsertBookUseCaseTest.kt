...
class UpsertBookUseCaseTest {
    ...
    @Test
    fun `successfully inserts new book`() =
        runTest {
            // Given
            val newBook =
                TestBookBuilder()
    ...
    @Test
    fun `successfully updates existing book but preserves personal metadata`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `handles book with complete data`() =
        runTest {
            // Given
    ...
    @Test
    fun `handles book with minimal data`() =
        runTest {
            // Given
    ...
    @Test
    fun `handles purchased book correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `handles multiple upserts sequentially`() =
        runTest {
            // Given
    ...
    @Test
    fun `preserves spine color when upserting`() =
        runTest {
            // Given
    ...
    @Test
    fun `handles book update preserving purchased status from existing book`() =
        runTest {
            // Given
            val originalBook =
                TestBookBuilder()
            ...
            // Personal metadata (purchased) should be preserved from existing book
            assertEquals(
                "Should preserve purchased status",
                false,
                mockRepository.getBookById("toggle-book")?.purchased,
            )
        }

    @Test
    fun `preserves personal metadata when upserting existing book`() =
        runTest {
    ...
    @Test
    fun `uses API data as-is for new books`() =
        runTest {
