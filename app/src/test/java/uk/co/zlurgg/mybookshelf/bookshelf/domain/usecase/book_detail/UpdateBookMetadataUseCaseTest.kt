...
class UpdateBookMetadataUseCaseTest {
    ...
    @Test
    fun `successfully updates reading status`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `successfully updates personal rating`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `successfully updates personal notes`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `successfully updates purchase date`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `returns validation error for invalid rating below 0_0`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `returns validation error for invalid rating above 5_0`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `returns validation error for notes exceeding 5000 characters`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `auto-sets dateAdded when not already set`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `preserves existing dateAdded when already set`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns error when repository throws exception`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `successfully updates all fields at once`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `allows exactly 5000 character notes`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `allows rating of exactly 1_0`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `allows rating of exactly 5_0`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
    ...
    @Test
    fun `allows rating of exactly 0_0 to clear rating`() =
        runTest {
    ...
    @Test
    fun `preserves existing values when only updating one field`() =
        runTest {
            // Given
            val existingBook =
                TestBookBuilder()
