...
class SyncBookClubUseCaseImplTest {
    ...
    @Test
    fun `execute - when sync succeeds with no changes - returns zero counts`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when sync adds books - returns correct added count`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when sync removes books - returns correct removed count`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when sync adds and removes books - returns both counts`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - calls repository with correct parameters`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when repository returns NETWORK_ERROR - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when repository returns NOT_SIGNED_IN - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when repository returns CLUB_NOT_FOUND - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when repository returns PERMISSION_DENIED - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when repository returns NOT_MEMBER - propagates error`() =
        runTest {
            // Given
