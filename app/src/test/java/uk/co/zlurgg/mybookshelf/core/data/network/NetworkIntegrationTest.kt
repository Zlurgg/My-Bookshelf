...
class NetworkIntegrationTest {
    @Test
    fun `ErrorMapper correctly maps network exceptions`() =
        runTest {
    ...
    @Test
    fun `ErrorMapper handles serialization exceptions`() =
        runTest {
    ...
    @Test
    fun `ErrorMapper handles generic exceptions`() =
        runTest {
    ...
    @Test
    fun `Result pattern works correctly for success cases`() =
        runTest {
    ...
    @Test
    fun `Result pattern works correctly for error cases`() =
        runTest {
            // Given - Error results
    ...
    @Test
    fun `DataError Remote enum has expected values`() =
        runTest {
    ...
    @Test
    fun `DataError Local enum has expected values`() =
        runTest {
    ...
    @Test
    fun `ErrorMapper safeCall handles local operations correctly`() =
        runTest {
    ...
    @Test
    fun `mapHttpStatusToDataError maps status codes correctly`() =
        runTest {
    ...
    @Test
    fun `ErrorMapper supports both Ktor and Java exceptions`() =
        runTest {
            ...
            assertEquals(
                "Java timeout should map to REQUEST_TIMEOUT",
                DataError.Remote.REQUEST_TIMEOUT,
                javaTimeoutError,
            )
            assertEquals(
                "Ktor timeout should map to REQUEST_TIMEOUT",
                DataError.Remote.REQUEST_TIMEOUT,
                ktorTimeoutError,
            )
    ...
    @Test
    fun `ErrorMapper handles Kotlinx serialization exceptions specifically`() =
        runTest {
            ...
            assertEquals(
                "Kotlinx serialization should map to SERIALIZATION",
                DataError.Remote.SERIALIZATION,
                kotlinxError,
            )
    ...
    @Test
    fun `Result pattern supports chaining operations`() =
        runTest {
