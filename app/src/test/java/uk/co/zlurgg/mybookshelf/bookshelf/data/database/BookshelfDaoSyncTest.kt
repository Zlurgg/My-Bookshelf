...
class BookshelfDaoSyncTest {
    ...
    @Test
    fun `getPendingSyncBooks returns books with non-SYNCED status`() =
        runTest {
    ...
    @Test
    fun `getPendingSyncShelves returns shelves with non-SYNCED status`() =
        runTest {
    ...
    @Test
    fun `getPendingSyncCrossRefs returns cross refs with non-SYNCED status`() =
        runTest {
    ...
    @Test
    fun `updateBookSyncStatus updates status and timestamp`() =
        runTest {
            // Given
            dao.upsert(createTestBook("book-1", "Book 1", syncStatus = "PENDING"))
    ...
    @Test
    fun `updateShelfSyncStatus updates status and timestamp`() =
        runTest {
            // Given
            dao.upsertShelf(createTestShelf("shelf-1", "Shelf 1", 0, syncStatus = "PENDING"))
    ...
    @Test
    fun `updateCrossRefSyncStatus updates status and timestamp`() =
        runTest {
            // Given
            dao.upsert(createTestBook("book-1", "Book 1"))
            dao.upsertShelf(createTestShelf("shelf-1", "Shelf 1", 0))
    ...
    @Test
    fun `assignOwnerToOrphanBooks assigns userId to books without owner`() =
        runTest {
    ...
    @Test
    fun `assignOwnerToOrphanShelves assigns userId to shelves without owner`() =
        runTest {
    ...
    @Test
    fun `getBooksByOwner returns only books owned by specified user`() =
        runTest {
            // Given
    ...
    @Test
    fun `getShelvesByOwner returns shelves ordered by position`() =
        runTest {
            // Given
    ...
    @Test
    fun `markAllBooksPending updates all books for owner to PENDING status`() =
        runTest {
            // Given
    ...
    @Test
    fun `markAllShelvesPending updates all shelves for owner to PENDING status`() =
        runTest {
            // Given
    ...
    @Test
    fun `getShelfByShareCode returns shelf with matching code`() =
        runTest {
            // Given
            dao.upsertShelf(
    ...
    @Test
    fun `getShelfByShareCode returns null for non-existent code`() =
        runTest {
            // Given
            dao.upsertShelf(createTestShelf("shelf-1", "Shelf 1", 0))
    ...
    @Test
    fun `updateShelfSharingStatus updates sharing fields`() =
        runTest {
            // Given
            dao.upsertShelf(
    ...
    @Test
    fun `syncDao upsertSyncMetadata creates new metadata`() =
        runTest {
            // Given
            val metadata =
                SyncMetadataEntity(
    ...
    @Test
    fun `syncDao getSyncMetadata returns null for non-existent user`() =
        runTest {
            // When
    ...
    @Test
    fun `syncDao observeSyncMetadata emits updates`() =
        runTest {
            // Given
            val metadata =
                SyncMetadataEntity(
    ...
    @Test
    fun `syncDao updateLastSyncTimestamp updates only timestamp`() =
        runTest {
            // Given
    ...
    @Test
    fun `syncDao updateSyncInProgress updates flag`() =
        runTest {
            // Given
            syncDao.upsertSyncMetadata(
                SyncMetadataEntity(
    ...
    @Test
    fun `syncDao updateLastSyncError updates error message`() =
        runTest {
            // Given
            syncDao.upsertSyncMetadata(
                SyncMetadataEntity(
    ...
    @Test
    fun `syncDao deleteSyncMetadata removes metadata`() =
        runTest {
            // Given
            syncDao.upsertSyncMetadata(
                SyncMetadataEntity(
