...
class ShareBookshelfUseCaseTest {
    ...
    @Test
    fun `delegates share to export service successfully`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns error when export service fails`() =
        runTest {
            // Given
    ...
    @Test
    fun `propagates export service result correctly`() =
        runTest {
            // Given
