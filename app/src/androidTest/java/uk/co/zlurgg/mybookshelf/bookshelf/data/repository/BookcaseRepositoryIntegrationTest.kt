...
class BookcaseRepositoryIntegrationTest {
    ...
    @Test
    fun updateShelfPersistsChanges() = runTest {
        // Given - Shelf exists in database
        val originalShelf = Bookshelf(
            id = "shelf-1",
            name = "Original Name",
            books = emptyList(),
            shelfStyle = ShelfStyle.DarkWood,
    ...
    @Test
    fun removeShelfDeletesFromDatabase() = runTest {
        // Given - Shelf exists
        val shelf = Bookshelf(
            id = "shelf-1",
            name = "To Delete",
    ...
    @Test
    fun getAllShelvesReturnsOrderedByPosition() = runTest {
    ...
    @Test
    fun getBookCountForShelfReturnsCorrectCount() = runTest {
    ...
    @Test
    fun removeShelfCascadesAndRemovesCrossRefs() = runTest {
        // Given - Shelf with books
        val shelfId = "shelf-1"
        val bookId = "book-1"
    ...
    @Test
    fun shelfPositionsPersistAcrossRepositoryRecreation() = runTest {
