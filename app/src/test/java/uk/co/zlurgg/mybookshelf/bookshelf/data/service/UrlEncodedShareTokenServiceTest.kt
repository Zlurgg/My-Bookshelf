...
class UrlEncodedShareTokenServiceTest {
    ...
    @Test
    fun `generateToken with simple JSON returns success with encoded string`() = runTest {
        // Given
    ...
    @Test
    fun `generateToken with realistic bookshelf JSON returns success`() = runTest {
        // Given
        val bookshelfJson = """
            {
              "formatVersion": 1,
    ...
    @Test
    fun `getShelfDataByToken with valid token returns original JSON`() = runTest {
        // Given
    ...
    @Test
    fun `getShelfDataByToken with invalid token returns error`() = runTest {
        // Given
    ...
    @Test
    fun `getShelfDataByToken with corrupted token returns error`() = runTest {
        // Given - Valid Base64 but not valid GZip data
        val corruptedToken = android.util.Base64.encodeToString(
    ...
    @Test
    fun `generateToken with empty string returns success`() = runTest {
        // Given
        val emptyJson = ""
    ...
    @Test
    fun `getShelfDataByToken with empty token returns error`() = runTest {
        // Given
        val emptyToken = ""
    ...
    @Test
    fun `cleanupExpiredTokens always returns success`() = runTest {
    ...
    @Test
    fun `round trip with Unicode characters preserves data`() = runTest {
        // Given
    ...
    @Test
    fun `round trip with large bookshelf preserves data`() = runTest {
        // Given - 10 books
    ...
    @Test
    fun `generateToken produces consistent results for same input`() = runTest {
        // Given
    ...
    @Test
    fun `token does not contain problematic URL characters`() = runTest {
        // Given
