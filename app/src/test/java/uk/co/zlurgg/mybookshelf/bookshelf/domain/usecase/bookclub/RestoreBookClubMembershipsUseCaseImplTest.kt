...
class RestoreBookClubMembershipsUseCaseImplTest {
    ...
    @Test
    fun `invoke - when user not signed in - returns NOT_SIGNED_IN error`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke - when user signed in - queries memberships with user ID`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke - when no memberships exist - returns zero counts`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke - when single membership exists - restores it successfully`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `invoke - when multiple memberships exist - restores all successfully`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.getRemoteClubMembershipsResult =
                Result.Success(
    ...
    @Test
    fun `invoke - calls restoreClubMembership for each code`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `invoke - when one restore fails - counts failure correctly`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `invoke - when some restores fail - counts mixed results correctly`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `invoke - when getRemoteClubMemberships fails - propagates error`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `invoke - when getRemoteClubMemberships returns PERMISSION_DENIED - propagates error`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `invoke - does not query memberships when not signed in`() =
        runTest {
            // Given
            mockAuthService.configureSignedOut()
    ...
    @Test
    fun `invoke - restore failure does not stop processing remaining clubs`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.getRemoteClubMembershipsResult =
