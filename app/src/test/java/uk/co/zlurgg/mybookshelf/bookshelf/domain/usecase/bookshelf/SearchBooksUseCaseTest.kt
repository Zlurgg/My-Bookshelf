...
class SearchBooksUseCaseTest {
    ...
    @Test
    fun `execute calls remote data source with correct parameters`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute returns mapped books when successful`() =
        runTest {
            // Given
            val testBooks =
                listOf(
    ...
    @Test
    fun `execute returns empty list when no results found`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute returns error when network fails`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute handles request timeout error`() =
        runTest {
            // Given
            mockRemoteDataSource.shouldThrowException = true
    ...
    @Test
    fun `execute rejects query exceeding 200 characters`() =
        runTest {
    ...
    @Test
    fun `execute accepts query at exactly 200 characters`() =
        runTest {
    ...
    @Test
    fun `execute rejects author filter exceeding 100 characters`() =
        runTest {
    ...
    @Test
    fun `execute accepts author filter at exactly 100 characters`() =
        runTest {
    ...
    @Test
    fun `execute rejects title filter exceeding 200 characters`() =
        runTest {
    ...
    @Test
    fun `execute accepts title filter at exactly 200 characters`() =
        runTest {
    ...
    @Test
    fun `execute rejects when multiple filters exceed limits`() =
        runTest {
