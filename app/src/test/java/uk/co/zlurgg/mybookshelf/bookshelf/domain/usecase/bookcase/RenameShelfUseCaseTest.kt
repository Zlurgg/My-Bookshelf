...
class RenameShelfUseCaseTest {
    ...
    @Test
    fun `successfully renames shelf with valid new name`() =
        runTest {
    ...
    @Test
    fun `returns error when shelf not found`() =
        runTest {
    ...
    @Test
    fun `returns error when new name is empty`() =
        runTest {
    ...
    @Test
    fun `allows renaming to existing shelf name (duplicates allowed)`() =
        runTest {
    ...
    @Test
    fun `allows renaming to same name (case insensitive)`() =
        runTest {
    ...
    @Test
    fun `preserves all shelf properties except name`() =
        runTest {
