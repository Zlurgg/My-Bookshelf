...
class SerializationIntegrationTest {
    ...
    private val mockRemoteDataSource =
    ...
    @Test
    fun serializeEmptyShelfSucceeds() =
        runTest {
            // Given - Empty shelf
            val shelf =
                Bookshelf(
    ...
    @Test
    fun deserializeInvalidJsonReturnsError() =
        runTest {
            // Given - Invalid JSON
    ...
    @Test
    fun personalMetadataNotInExportedJson() =
        runTest {
            ...
            assertFalse(
                "JSON should not contain private notes text",
                jsonString.contains("Private notes that should never be shared"),
            )
