...
class JoinBookClubUseCaseImplTest {
    ...
    @Test
    fun `returns NOT_SIGNED_IN error when user is not signed in`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns AlreadyMember when user is already a member`() =
        runTest {
            // Given
    ...
    @Test
    fun `checks membership with correct code`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `returns CLUB_NOT_FOUND when club does not exist`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.configureNotMember()
    ...
    @Test
    fun `returns Success with shelf info when join succeeds`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.configureNotMember()
    ...
    @Test
    fun `calls repository joinBookClub with correct code`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.configureNotMember()
    ...
    @Test
    fun `propagates membership check error`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
    ...
    @Test
    fun `propagates getBookClub error`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.configureNotMember()
    ...
    @Test
    fun `propagates joinBookClub error`() =
        runTest {
            // Given
            mockAuthService.configureSignedIn()
            mockRepository.configureNotMember()
    ...
    @Test
    fun `handles member in Firestore but no local shelf gracefully`() =
        runTest {
