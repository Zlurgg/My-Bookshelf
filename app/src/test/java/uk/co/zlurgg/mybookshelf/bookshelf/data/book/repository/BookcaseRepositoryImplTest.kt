...
class BookcaseRepositoryImplTest {
    ...
    @Test
    fun `getAllShelves returns empty list when no shelves exist`() = runTest {
        // When
    ...
    @Test
    fun `addShelf creates new shelf in database`() = runTest {
        // Given
    ...
    @Test
    fun `getAllShelves returns shelves in position order`() = runTest {
        // Given
    ...
    @Test
    fun `getShelfById returns correct shelf when it exists`() = runTest {
        // Given
        val shelf = TestShelfBuilder()
    ...
    @Test
    fun `updateShelf modifies existing shelf data`() = runTest {
        // Given
        ...
        val updatedShelf = originalShelf.copy(
            name = "Updated Name",
    ...
    @Test
    fun `updateShelf works as upsert for non-existent shelf`() = runTest {
        // Given
        val newShelf = TestShelfBuilder()
            .withId("upsert-shelf")
    ...
    @Test
    fun `removeShelf handles non-existent shelf gracefully`() = runTest {
    ...
    @Test
    fun `getBookCountForShelf returns zero for empty shelf`() = runTest {
        // Given
    ...
    @Test
    fun `getBookCountForShelf returns correct count after adding books`() = runTest {
        // Given
    ...
    @Test
    fun `getBookCountForShelf returns zero for non-existent shelf`() = runTest {
        // When
    ...
    @Test
    fun `removeShelf cleans up cross-references`() = runTest {
        // Given
    ...
    @Test
    fun `multiple shelf operations work correctly`() = runTest {
        // Given
    ...
    @Test
    fun `different shelf styles are preserved correctly`() = runTest {
        // Given
        val darkWoodShelf = TestShelfBuilder()
            .withId("dark-wood")
            .withStyle(ShelfStyle.DarkWood)
            .build()

        val silverMetalShelf = TestShelfBuilder()
            .withId("silver-metal")
            .withStyle(ShelfStyle.SilverMetal)
            .build()

        val whiteMetalShelf = TestShelfBuilder()
            .withId("white-metal")
            .withStyle(ShelfStyle.WhiteMetal)
            .build()
    ...
    @Test
    fun `shelf positions can be updated correctly`() = runTest {
        // Given
