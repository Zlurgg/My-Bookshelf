...
class ValidatorIntegrationTest {
    ...
    @Test
    fun validateFormatAcceptsValidData() =
        runTest {
    ...
    @Test
    fun validateFormatRejectsBlankShelfName() =
        runTest {
    ...
    @Test
    fun checkNameConflictReturnsNullWhenNoConflict() =
        runTest {
    ...
    @Test
    fun checkNameConflictReturnsNameWhenConflictExists() =
        runTest {
            // Given - Database with existing shelf
            val existingShelf =
                Bookshelf(
    ...
    @Test
    fun checkNameConflictIsCaseSensitive() =
        runTest {
            // Given - Database with existing shelf
            val existingShelf =
                Bookshelf(
