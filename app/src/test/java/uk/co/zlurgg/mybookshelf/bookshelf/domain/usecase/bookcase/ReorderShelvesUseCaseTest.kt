...
class ReorderShelvesUseCaseTest {
    ...
    @Test
    fun `execute moves shelf from position 0 to position 2`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute moves shelf from position 2 to position 0`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute moves shelf from middle to middle position`() =
        runTest {
            // Given - 5 shelves
            val shelves =
                (0..4).map { i ->
    ...
    @Test
    fun `execute handles moving shelf to same position`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute clamps new position to valid range - position too high`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute clamps new position to valid range - negative position`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute returns error when shelf not found in current list`() =
        runTest {
            // Given
            val currentShelves =
                listOf(
    ...
    @Test
    fun `execute preserves shelf data during reordering`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute calls repository updateShelf for affected shelves only`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `execute handles single shelf list`() =
        runTest {
            // Given
            val singleShelf =
                listOf(
    ...
    @Test
    fun `execute handles empty shelf list gracefully`() =
        runTest {
            // Given
