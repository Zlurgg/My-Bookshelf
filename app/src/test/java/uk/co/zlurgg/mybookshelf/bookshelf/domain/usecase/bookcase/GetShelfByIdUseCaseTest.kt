...
class GetShelfByIdUseCaseTest {
    ...
    @Test
    fun `execute returns shelf when shelf exists`() =
        runTest {
            // Given
            val expectedShelf =
                TestShelfBuilder()
    ...
    @Test
    fun `execute returns null when shelf does not exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute returns shelf with complete data`() =
        runTest {
            // Given
            val books =
                listOf(
    ...
    @Test
    fun `execute handles various shelf ID formats`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute returns shelf with different shelf styles`() =
        runTest {
    ...
    @Test
    fun `execute returns shelf with empty book list`() =
        runTest {
            // Given
            val emptyShelf =
                TestShelfBuilder()
    ...
    @Test
    fun `execute returns shelf with single book`() =
        runTest {
            // Given
            val singleBook =
                TestBookBuilder()
    ...
    @Test
    fun `execute with different position values`() =
        runTest {
            // Test different position scenarios
            // Test positions: First, Second, Middle, High, Invalid/edge case
            val testCases = listOf(0, 1, 5, 999, -1)
