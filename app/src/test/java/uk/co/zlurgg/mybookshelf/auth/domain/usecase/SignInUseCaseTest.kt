...
class SignInUseCaseTest {
    ...
    @Test
    fun `execute returns success and saves signed in state when sign in succeeds`() =
        runTest {
    ...
    @Test
    fun `execute returns user data on success`() =
        runTest {
    ...
    @Test
    fun `execute returns error and does not save state when sign in fails`() =
        runTest {
    ...
    @Test
    fun `execute returns cancelled error when user cancels`() =
        runTest {
    ...
    @Test
    fun `execute returns no credential error when no account available`() =
        runTest {
    ...
    @Test
    fun `execute returns network error on network failure`() =
        runTest {
    ...
    @Test
    fun `execute schedules periodic sync on successful sign in`() =
        runTest {
            useCase.execute()
    ...
    @Test
    fun `execute triggers immediate sync on successful sign in`() =
        runTest {
            useCase.execute()
    ...
    @Test
    fun `execute does not schedule sync when sign in fails`() =
        runTest {
            mockSignInResult = Result.Error(DataError.Local.AUTH_FAILED)
