...
class GetAllShelvesUseCaseTest {
    ...
    @Test
    fun `returns empty bookcase when no shelves exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns bookcase with single shelf and correct book count`() =
        runTest {
            // Given
            val shelf =
                TestShelfBuilder()
    ...
    @Test
    fun `returns bookcase with multiple shelves and book counts`() =
        runTest {
            // Given
            val shelves =
                listOf(
    ...
    @Test
    fun `returns bookcase with zero book counts for shelves`() =
        runTest {
            // Given
            val shelf =
                TestShelfBuilder()
    ...
    @Test
    fun `returns shelves sorted by position`() =
        runTest {
