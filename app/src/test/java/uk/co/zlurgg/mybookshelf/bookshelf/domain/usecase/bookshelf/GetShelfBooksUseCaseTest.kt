...
class GetShelfBooksUseCaseTest {
    ...
    @Test
    fun `returns empty list when shelf has no books`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns single book when shelf has one book`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns multiple books when shelf has multiple books`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns correct books for specific shelf ID`() =
        runTest {
            // Given
    ...
    @Test
    fun `handles purchased books correctly`() =
        runTest {
            // Given
    ...
    @Test
    fun `returns empty list for non-existent shelf`() =
        runTest {
            // Given
    ...
    @Test
    fun `handles repository configuration correctly`() =
        runTest {
