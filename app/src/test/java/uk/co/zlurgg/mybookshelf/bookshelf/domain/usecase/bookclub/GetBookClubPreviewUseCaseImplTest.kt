...
class GetBookClubPreviewUseCaseImplTest {
    ...
    @Test
    fun `invoke - when club exists - returns book club data`() =
        runTest {
            // Given
            val expectedClub =
                BookClub(
    ...
    @Test
    fun `invoke - calls repository with correct code`() =
        runTest {
            // Given
            val code = "MYCLUB99"
    ...
    @Test
    fun `invoke - when club not found - returns null in success`() =
        runTest {
            // Given
            mockRepository.configureBookClubNotFound()
    ...
    @Test
    fun `invoke - when repository returns NETWORK_ERROR - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke - when repository returns PERMISSION_DENIED - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke - when repository returns NOT_SIGNED_IN - propagates error`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke - preserves all book club fields from repository`() =
        runTest {
            // Given
