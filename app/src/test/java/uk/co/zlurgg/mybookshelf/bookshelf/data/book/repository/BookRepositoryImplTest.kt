...
class BookRepositoryImplTest {
    ...
    fun setup() {
        ...
        repository = BookRepositoryImpl(mockRemoteDataSource, database.bookshelfDao)
    }
    ...
    fun `getBookDescription returns success when remote source succeeds`() = runTest {
        ...
        val mockBookDetails = uk.co.zlurgg.mybookshelf.bookshelf.data.book.dto.BookWorkDto(
