...
class BookRepositoryIntegrationTest {
    ...
    @Test
    fun addBookAndRetrieveFromRealDatabase() =
        runTest {
    ...
    @Test
    fun deleteBookRemovesFromDatabase() =
        runTest {
            // Given - Book exists in database
    ...
    @Test
    fun multipleBooksPersistedCorrectly() =
        runTest {
    ...
    @Test
    fun databasePersistsAcrossReinitializations() =
        runTest {
    ...
    @Test
    fun personalMetadataPersistsCorrectly() =
        runTest {
            // Given - Book with personal metadata
            val book =
                createTestBookEntity("book-1", "Personal Metadata Book")
                    .copy(
