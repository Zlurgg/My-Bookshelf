...
class CreateBookClubUseCaseImplTest {
    ...
    @Test
    fun `execute - when repository succeeds - returns club code`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - calls repository with correct shelf ID`() =
        runTest {
            // Given
    ...
    @Test
    fun `execute - when repository returns QUOTA_EXCEEDED - propagates error`() =
        runTest {
            // Given
            val shelfId = "test-shelf"
    ...
    @Test
    fun `execute - with empty shelf ID - delegates to repository`() =
        runTest {
            // Given
            val emptyShelfId = ""
